...
const TRANSLATIONS = {
  en: {
    ...
    portCta:         'Get A Marketing Consultant To Call You',
    ...
    ctaBtn1:         'Get A Marketing Consultant To Call You',
    ...
    contactBtn4:     'Learn to Create Viral Content',
    ...
    modalQuote:      'Get A Marketing Consultant To Call You',
  ...
  ar: {
    ...
    contactBtn4:     'تعلّم إنشاء المحتوى الفيروسي',
...
const services = {
  content: {
    en: {
      ...
      quoteLabel: 'Get A Marketing Consultant To Call You',
